...
template<> MOVEIT_API UScriptStruct* StaticStruct<FAnimNode_MIBlendSpacePlayer>()
{
	...
	struct Z_CompiledInDeferFile_FID_MetrovaniaGameJam_Plugins_MoveIt_Source_MoveIt_Public_AnimNodes_UnrealBase_AnimNode_MIBlendSpacePlayer_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MetrovaniaGameJam_Plugins_MoveIt_Source_MoveIt_Public_AnimNodes_UnrealBase_AnimNode_MIBlendSpacePlayer_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MetrovaniaGameJam_Plugins_MoveIt_Source_MoveIt_Public_AnimNodes_UnrealBase_AnimNode_MIBlendSpacePlayer_h_1095821135(TEXT("/Script/MoveIt"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_MetrovaniaGameJam_Plugins_MoveIt_Source_MoveIt_Public_AnimNodes_UnrealBase_AnimNode_MIBlendSpacePlayer_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MetrovaniaGameJam_Plugins_MoveIt_Source_MoveIt_Public_AnimNodes_UnrealBase_AnimNode_MIBlendSpacePlayer_h_Statics::ScriptStructInfo),
		nullptr, 0);
